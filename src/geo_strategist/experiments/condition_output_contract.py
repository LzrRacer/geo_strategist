"""Shared condition-output contract for C0-C14 workflow-condition records.

This module defines the common proposal-producing output surface that every
workflow condition (C0-C14) must emit, plus reusable validation helpers so that
...
def make_condition_record(
    *,
    ...
    """Build a condition record that satisfies the common C0-C14 output contract."""
