"""Shared infrastructure for live-agent conditions (C1/C4, C9-C13).
...
class LiveConditionResult:
    ...
    candidate_qualitative_assessments: list[dict[str, Any]] = field(default_factory=list)
    candidate_assessment_reviews: list[dict[str, Any]] = field(default_factory=list)
